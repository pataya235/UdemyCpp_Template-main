...
namespace fs = std::filesystem; //own alias for existing namespace here common

int main()
{
    fs::path workspace_path = "C:/UdemyCpp_Template-main";
    fs::path chapter_path;
    chapter_path = workspace_path;
    chapter_path /= "5_STLString"; //append to workspace path
