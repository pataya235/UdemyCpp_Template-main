...
int main()
{
    ...
    auto result1 = std::accumulate(my_vector1.begin(), my_vector2.begin(), 0);
    std::cout << result1 << std::endl;

    auto result2 = std::accumulate(my_vector1.begin(), my_vector2.begin(), 0, adder);
    std::cout << result2 << std::endl;

    auto result3 = std::accumulate(my_vector1.begin(), my_vector2.begin(), 0, multiplier);
