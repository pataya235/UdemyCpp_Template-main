...
int main()
{
    ...
    my_vector.erase(std::remove(my_vector.begin(), my_vector.end(), 2), my_vector.end()); //remove 2
    print_vector(my_vector);

    my_vector.erase(std::remove_if(my_vector.begin(), my_vector.end(), is_odd), my_vector.end()); //remove odd values
    print_vector(my_vector);
